      ...
      <div className="relative bg-card border border-border rounded-xl shadow-2xl w-full max-w-md p-6 space-y-5">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center text-primary-foreground font-bold text-lg">O</div>
            <div>
              <h2 className="font-bold text-foreground">OmniReach</h2>
              <p className="text-xs text-muted-foreground">React + Vite + TanStack + Rust</p>
            </div>
          </div>
        ...
        <div className="space-y-2">
          <p className="text-xs font-semibold text-foreground uppercase tracking-wide">Broadcast Integrity Rules</p>
        ...
        {/* Architecture */}
        <div className="space-y-2">
          <p className="text-xs font-semibold text-foreground uppercase tracking-wide">Architecture</p>
          <p className="text-xs text-muted-foreground leading-relaxed">
            OmniReach connects to a local WABridge daemon running on 127.0.0.1:8080.
            The Rust backend handles rate limiting, scheduling, and WhatsApp session management.
